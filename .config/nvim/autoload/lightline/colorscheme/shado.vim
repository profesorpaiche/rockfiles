...
" Tabline
let s:p.tabline.left    = [ [ PINK, BLACK ], [ GLASS, PINK] ]
let s:p.tabline.tabsel  = [ [ BLACK, PINK ], [ PINK, GLASS ] ]
let s:p.tabline.middle  = [ [ PINK, BLACK ] ]
let s:p.tabline.right   = [ [ PINK, BLACK ], [ GLASS, PINK ] ]

" Messages
let s:p.normal.error    = [ [ BLACK, ERR  ] ]
let s:p.normal.warning  = [ [ BLACK, WARN ] ]

let g:lightline#colorscheme#shado#palette = lightline#colorscheme#fill(s:p)
