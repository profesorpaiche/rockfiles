...
--
-- A tip for testing: Xephyr :5 & sleep 1 ; DISPLAY=:5 awesome
...
-- {{{ Wibar
-- Create a textclock and calendar
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
            weather_widget{
                api_key = "7683641b7f7dffb1094aba4ec122f50a",
                coordinates = {53.58907, 10.020894},
